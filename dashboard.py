...
st.write("""
        # Conclusion
         1. In the results of question 1, it can be seen that the PM2.5 levels at several stations fluctuate from year to year. Some stations show a significant increase or decrease in PM2.5 levels in certain years. In 2017, Gucheng City was a city with a pollution level compared to other cities of around 67. In the air quality index (AQI), a value of 67 is at a moderate level\n
         2. In 2014, the pollution level in Beijing was the highest compared to others, then decreased drastically until 2016. Then in mid-2016, it increased slightly until 2017\n
         3. In the third visualization result, it is concluded that the city with the highest pollution level from 2013-2017 is Gucheng City with a value of 70.97, and the city with the lowest air pollution level is Dingling City with a value of 58.49\n
""")
